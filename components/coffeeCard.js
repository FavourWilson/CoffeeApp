...
export default function CoffeeCard({ item }) {
  ...
  return (
    <View className='rounded-3xl h-[350px] w-[250px]' style={{backgroundColor:themeColors.bgDark}}>
          <View style={{ shadowColor: 'black', shadowRadius: 30, shadowOffset: { width: 0, height: 40 }, shadowOpacity: 0.8 }}
          ...
          <View className='flex-row space-x-1 z-10 mb-6 px-2'>
